...
export default function SignInPage() {
  return (
    <AuthLayout title="Welcome Back." subtitle="Membership Access">
      <SignIn
        appearance={{
          baseTheme: dark,
          variables: {
          ...
          elements: {
            ...
            formFieldAction: "text-white/50 hover:text-white text-[10px] uppercase tracking-widest transition-colors",
          },
        }}
      />
    </AuthLayout>
