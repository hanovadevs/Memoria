  ...
  return (
    <div className="min-h-screen">
      <Section className="pb-10 pt-32">
        <Container>
          <div className="mb-16">
            <h1 className="text-5xl font-bold tracking-tight mb-4">Categories</h1>
            <p className="text-neutral-500 max-w-md">Browse our collection by specialized creative categories.</p>
          </div>
